...
fn main() {
    ...
    let mut elements: Vec<Vec<(i32, i32)>> = Vec::new();
    for y in 0..rows {
        for x in 0..columns {
                ...
                for i in -1..=1 {
                    for j in -1..=1 {
                        ...
                        if (new_x - 1) == columns.try_into().unwrap() &&
                            ...
                            if found && !temp.contains(&(new_y, t as i32 + 1)) {
                                temp.push((new_y, t as i32 + 1));
                            }
                        }
                        else {
                            let mut found = false;
                            ...
                            if found && !temp.contains(&(new_y, t as i32)) {
                                temp.push((new_y, t as i32));
                            }
                        }
                    }
                }
